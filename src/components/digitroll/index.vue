 ...
 * @Description: 
 * @Author: 李大玄
 * @Date: 2021-11-11 14:48:28
 * @FilePath: /vue-shelf/src/components/digitroll/index.vue
-->
<template>
  <div class="d-roll-wrapper">
    <ul ref="list" class="d-roll-list">
      <li v-for="(item, i) of digitOffsetArr" :key="i" class="d-roll-item" :style="{ height: `${cellHeight}px` }">
        <div class="d-roll-bar" v-html="innerUnitHtml" :style="getliStyle(item, i)"></div>
      </li>
    </ul>
  </div>
</template>
