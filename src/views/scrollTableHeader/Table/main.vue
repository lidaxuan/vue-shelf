...
<template>
  ...
  <div :class="`e-table-sp e-table-${sizeComputed}-sp`" :style="{height}">
    ...
    <el-table v-bind="$attrs" :border="styleComputed === 'border'" v-on="$listeners" :data="data" ref="table" size="medium" height="100%" :row-class-name="rowClassNameComputed">
      <el-table-column fixed="left" v-if="showSelection" type="selection" width="70"></el-table-column>
      <el-table-column fixed="left" v-if="showSelection" type="index" label="序号" width="70"></el-table-column>
