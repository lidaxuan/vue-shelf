 ...
 * @Description:
 * @Author: 李大玄
 * @Date: 2023-07-03 09:38:03
 * @FilePath: /vue-shelf/src/views/MultipleRenderingComponents/_compLucksheet.vue
 * @LastEditors: 李大玄
 * @LastEditTime: 2023-07-03 09:38:04
-->
<template>
  <div class="wmax hmax">
    <el-button  @click="getData">获取表格数据</el-button>
    <div id="luckysheet" style="margin: 0px; padding: 0px; width: 100%; height: 95%; left: 0px; top: 0px"></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    init(formatterEntity) {
      const {luckysheetData} = formatterEntity;
      const _that = this;
      ...
      const data = [].concat(luckysheetData || []);
      ...
      const optionSheet = {
        ...
        hook: {
          ...
          cellUpdated: function (r, c, oldValue, newValue, isRefresh) {
            ...
            _that.$emit('cellUpdated', {r, c, oldValue, newValue, isRefresh});
          },
