 ...
 * @Description: 
 * @Author: 李大玄
 * @Date: 2021-12-13 11:11:12
 * @FilePath: /vue-shelf/src/views/g6/g6.vue
-->
<template>
  <div class="wmax hmax">
    <div id="container" ref="container" class="wmax hmax container"></div>
  </div>
</template>
  ...
  children: [
    {
      ...
      color: '#5AD8A6',
      children: [
        { label: 'Logistic regression', id: '0-1-1' },
        { label: 'Linear discriminant analysis', id: '0-1-2' },
        { label: 'Rules', id: '0-1-3' },
        { label: 'Decision trees', id: '0-1-4' },
        { label: 'Naive Bayes', id: '0-1-5' },
        { label: 'K nearest neighbor', id: '0-1-6' },
        { label: 'Probabilistic neural network', id: '0-1-7' },
        { label: 'Support vector machine', id: '0-1-8' },
      ],
    },
    {
      label: 'Consensus',
      ...
      children: [
        {
          ...
          id: '0-2-1',
          children: [
            { label: 'Different initializations', id: '0-2-1-1' },
            { label: 'Different parameter choices', id: '0-2-1-2' },
            { label: 'Different architectures', id: '0-2-1-3' },
            { label: 'Different modeling methods', id: '0-2-1-4' },
            { label: 'Different training sets', id: '0-2-1-5' },
            { label: 'Different feature sets', id: '0-2-1-6' },
          ],
        },
        {
          label: 'Methods',
          id: '0-2-2',
          children: [
            { label: 'Classifier selection', id: '0-2-2-1' },
            { label: 'Classifier fusion', id: '0-2-2-2' },
          ],
        },
        {
          label: 'Common',
          id: '0-2-3',
          children: [
            { label: 'Bagging', id: '0-2-3-1' },
            { label: 'Boosting', id: '0-2-3-2' },
            { label: 'AdaBoost', id: '0-2-3-3' },
          ],
        },
      ],
    },
    {
      ...
      color: '#269A99',
      children: [
        { label: 'Multiple linear regression', id: '0-3-1' },
        { label: 'Partial least squares', id: '0-3-2' },
        { label: 'Multi-layer feedforward neural network', id: '0-3-3' },
        { label: 'General regression neural network', id: '0-3-4' },
        { label: 'Support vector regression', id: '0-3-5' },
      ],
    },
  ],
};
export default {
  ...
  methods: {
    ...
    `;
      ...
      el.innerHTML = 'Double click on node to change title, hover node to display ops buttons\n双击修改节点标题, hover节点显示操作按钮';
