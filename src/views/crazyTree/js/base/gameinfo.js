...
export default class gameinfo {
  ...
  gameOver(score) {
    ...
    this.ctx.fillText('游戏结束', screenWidth / 2 - 50, screenHeight / 2 - 100 + 40)

    this.ctx.fillText('得分: ' + score, screenWidth / 2 - 50, screenHeight / 2 - 100 + 80)

    this.ctx.fillRect(screenWidth / 2 - 100, screenHeight / 2, 200, 50)

    this.ctx.fillStyle = "#883a3a"
    this.ctx.fillText('重新开始', screenWidth / 2 - 50, screenHeight / 2 - 100 + 130)
