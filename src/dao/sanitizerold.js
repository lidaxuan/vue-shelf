 ...
 * 默认标签与属性白名单
 */
export const DEFAULT_ALLOWED_TAGS = ["audio", 'b', 'i', 'u', 'strong', 'em', 'br', 'p', 'ul', 'ol', 'li', 'a', 'img', 'h1', 'h2', 'h3', 'span', "div"];
...
(function installHooks() {
  DOMPurify.addHook('uponSanitizeAttribute', function (node, data) {
    ...
    if ((attr === 'src' || attr === 'href') && typeof val === 'string') {
      ...
      try {
        const url = new URL(data.attrValue, window.location.origin);// http://
